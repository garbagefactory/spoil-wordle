...
/**
@name spoilWordle
* @description returns the wordle answer on a specified day. This package runs on UNIX time using the javascript Date object, so it is sensitive to the timezone of the system it's being run on.
* @param {int} daysAfterToday specifies what day's wordle. Ex. To get tomorrow's wordle, pass 1. If not specified, will return today's wordle. 
* 
